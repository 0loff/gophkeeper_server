...
- Переключиться на ветку GS-2
- Скопировать .env.example в .env
- В .env добавить переменную `DATABASE_DSN` конфига для соединения с БД
- Для запуска gRPC сервера выполнить команду `make` в терминале

## Старт клиента

- Открыть новый терминал в полноэкранном режиме
- В репозитории gophkeeper_server выполнить запуск клиента `./client`
